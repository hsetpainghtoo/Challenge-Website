    ...
    <>
      <div className="flex justify-between mt-5 mb-12">
        ...
        <div className="flex justify-center items-center ">          
          ...
          <a href="#" className="mx-7 font-semibold text-lg hover:text-red-600 focus:text-red-400">Home</a>
          <a href="#" className="font-semibold text-lg  hover:text-red-600 focus:text-red-400">New</a>
          <a href="#" className="mx-7 font-semibold text-lg  hover:text-red-600 focus:text-red-400">Popular</a>
          <a href="#" className="font-semibold text-lg  hover:text-red-600 focus:text-red-400">Trending</a>
          <a href="#" className="ml-7 font-semibold text-lg  hover:text-red-600 focus:text-red-400">Categories</a>
          </div>
